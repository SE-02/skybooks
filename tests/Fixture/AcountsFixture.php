...
class AcountsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'string', 'length' => 1, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '0:chưa xác nhận, 1:đã xác nhận, 2:đã khóa', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created_at' => '2018-11-30 15:55:29',
            'updated_at' => '2018-11-30 15:55:29'
        ],
    ];
}
